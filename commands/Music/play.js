...
if (!args[0] && getAttachmentURL) {
            ...
            if (!player.isPlaying && !player.isPaused) player.play();
              ...
              embed.setAuthor({ name: `Queued 1 file` , iconURL:message.author.displayAvatarURL()})
           embed.setColor(client.config.color)
...
iconURL:message.author.displayAvatarURL()})
     ...
     if (!player.isPlaying && !player.isPaused){ 
      ...
      track.info.requester = message.author;
       ...
       .setDescription(`
[${track.info.title}](${track.info.uri}) by [${track.info.author}](${client.config.support}) `)
